...
\usepackage[backend=bibtex,style=ieee,sorting=none,sortcites=true,isbn=false,url=false,doi=false,block=space,defernumbers=true]{biblatex}
...
\frametitle{Conclusion}
  \begin{itemize}
  \item There are two main approaches to compilation: the algebraic approach and the traditional approach based on commuting diagrams
    \begin{itemize}
    \item The algebraic approach offers advantages over the more traditional approach
    \end{itemize}
