...
\begin{frame}
  ...
  The following diagram illustrates the structure of the algebraic approach.
  ...
  \begin{tikzpicture}
    ...
    \path (3.5cm,2cm) 
    edge[->] node[align=center, above] {\LARGE $\sqsubseteq$} 
    node[align=center, below] {Refinement\\Strategy\\(Compilation)}  (6.5cm,2cm);
  \end{tikzpicture}
\end{frame}
