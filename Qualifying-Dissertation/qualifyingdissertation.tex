...
formal model of the virtual machine services that we have created must have a
formal proof of correctness and this may require revision of the formal model
due to errors uncovered in the process of proving.  The specification of the
core execution environment will be a proof of correct compilation from Java
bytecode to C using the algebraic approach.  As already discussed, this will
involve defining the semantics of Java bytecode and C in terms of \Circus{}
and proving refinement laws between them.  We will mechanise these proofs in the
Isabelle proof assistant in order to have assurance that the proofs are sound.
...
correct virtual machine can be constructed from our model in a step-wise and modular
