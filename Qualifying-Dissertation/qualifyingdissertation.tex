...
\section{Compilation Strategy}
 ...
 from Java bytecode to C. The reason for the choice of C as
...
% conclude with a final considerations section - one paragraph saying what has
% already been done and pointing to the next chapter
...
%  LocalWords:  nondeterministically boolean datatype
