...
The the bytecode instructions in our subset are described in
...
\begin{table}
  ...
  \begin{tabular}{llp{8cm}}
    ...
    the specified field for the referenced object, and pushes it onto
    the operand stack.
    \\
    \texttt{invokespecial} & &
    Invoke the specified method of the specified class, popping the
    method's arguments, including a \texttt{this} object reference,
    from the operand stack.
    \\
    \texttt{invokevirtual} & &
    Pops the arguments of the specified method, including a
    \texttt{this} object reference, from the operand stack and invokes
    the specified method of the class of referenced object.
    \\
    \texttt{new} & &
    Allocates a new object of the specified class and pushes a
    reference to the new object onto the operand stack.
    \\
    \texttt{putfield} & &
    Pops an object reference and value from the operand stack and
    stores the value in the specified field of the referenced object.
    \\
    \texttt{return} & &
