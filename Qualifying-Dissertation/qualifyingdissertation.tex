...
%but it must be shown that the programs can be executed correctly in order to be certain of the resultant software's correctness.
...
%TODO: mention the work done on compiling Java for embedded systems
%TODO: mention the importance of compiler verification and some of the work done
