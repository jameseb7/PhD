...
This popularity has spawned many variants for Java for different uses, including JavaCard\cite{chen2000}, Java ME \cite{oracle2014} and the Real-Time Specification for Java (RTSJ) \cite{gosling2000}, as well as some languages derived from Java such as Scala\cite{lausanne2015} and Ceylon\cite{redhat2015}.
