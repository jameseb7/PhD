...
% mention Icecap's SCJ API implementation - check earlier versions of the JTRES
% paper
% mention that Icecap is free and open source
Icecap also provides a lightweight Java bytecode interpreter and allows for
interpreted code to be mixed with compiled code. HVM\textsubscript{TP} is a
