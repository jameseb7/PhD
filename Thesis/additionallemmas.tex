...
\begin{lem}[$class$-assump-$AllocateObject$-dist]
  ...
  \begin{crproof}
    \begin{argue}
      \begin{array}{l}
        \{ g \} \circseq AllocateObject(t, s, o)
      \end{array}\\
      = & Law~[\nameref{copy-rule-law}] and definition of $AllocateObject$ \\
      \begin{array}{l}
        \{ g \} \circseq \\
      ...
      \begin{array}{l}
        ...
        \t1 o := objectID)
      \end{array}\\
      \circrefines_A & Law~[\nameref{assump-output-prefix-dist-move-law}] and Law~[\nameref{assump-input-prefix-dist-move-law}] \\
      \begin{array}{l}
        (\circvar thread : ThreadID; size : \nat \circspot \\
        \t1 \{ g \} \circseq thread, size := t, s \circseq \\
        \t1 \circvar objectID : ObjectID \circspot \\
