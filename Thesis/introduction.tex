...
As many existing\deleted{ virtual machines for} SCJ \added{virtual
  machines} precompile programs to native code in order to allow
...
This is followed by a model of\deleted{ the} an SCJ virtual machine
...
\url{https://www.cs.york.ac.uk/circus/hijac/code/18-baxter_Thesis_Additional_Files-20181214T172909Z-001.zip}.
}