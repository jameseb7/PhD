...
domain of $objects$ is partitioned by the $ObjectID$ sets given by
...
$classObjectMap$ be in the $objects$ map.
...
contains the $CEEswitchThread.t.t2$ and $CEEswitchThread.t2.t$ events
for all threads identifiers $t2$.
