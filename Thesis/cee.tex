...
Some channels are marked with various symbols (*, \dag{} and {}+{}) so
that we can refer to them later in the text.
...
\begin{table}[thp]
  \begin{center}
    \begin{tabular}{@{}lllll}
      ...
      * & $register$ & $ThreadID \cross ObjectID$ & I & L \\
      * & $registerRet$ & \textless no parameters\textgreater & L & I \\
      * & $enterPrivateMemory$ & $ThreadID \cross \nat \cross ObjectID$ & I & L \\
      * & $enterPrivateMemoryRet$ & \textless no parameters\textgreater & L & I \\
      * & $executeInAreaOf$ & $ThreadID \cross ObjectID \cross ObjectID$ & I & L \\
      * & $executeInAreaOfRet$ & \textless no parameters\textgreater & L & I \\
      * & $executeInOuterArea$ & $ThreadID \cross ObjectID$ & I & L \\
      * & $executeInOuterAreaRet$ & \textless no parameters\textgreater & L & I \\
      & $enterPerReleaseMemory$ & $ThreadID \cross ObjectID$ & I & L \\
      & $enterPerReleaseMemoryRet$ & \textless no parameters\textgreater & L & I \\
      & $exitMemory$ & $ThreadID$ & I & L \\
      & $exitMemoryRet$ & \textless no parameters\textgreater & L & I \\
      ...
      \dag & $getClassIDOf$ & $ObjectID \cross ClassID$ & I/L & OM  \\
      \dag & $getField$ & $ObjectID \cross FieldID$ & I & OM \\
      \dag & $getFieldRet$ & $Word$ & OM & I \\
      \dag & $putField$ & $ObjectID \cross FieldID \cross Word$ & I & OM \\
      \dag & $getStatic$ & $ClassID \cross FieldID$ & I & OM \\
      \dag & $getStaticRet$ & $Word$ & OM & I \\
      \dag & $putStatic$ & $ClassID \cross FieldID \cross Word$ & I & OM \\
