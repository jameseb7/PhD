...
return values.
This better represents the semantics corresponding \Circus{} code.
...
We follow guidelines for safety-critical uses of C
variants, such as MISRA-C~\cite{MISRA}, and use a single return
...
inter type from C99 with the same width as a pointer, to ensure the
