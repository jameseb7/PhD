...
which are proved from laws whose corrctness has been previously
...
we can easily produce the ouput of the strategy and compare it to the
...
bytecode in the intepreter model, this validates the semantics in our
interpreter model.
}
