...
\begin{restatable}[$getClassIDOf$-$poppedArgs$-elimination]{crule}{GetClassIDOfMethodParameterIntroductionRule}
...
\begin{restatable}[$getClassIDOf$-multi-$poppedArgs$-elimination]{crule}{GetClassIDOfMultiMethodParameterIntroductionRule}
