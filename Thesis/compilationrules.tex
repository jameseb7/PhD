...
% TODO: need rules for the areturn cases here
...
\begin{restatable}[eliminate-$oid$-$getField$]{crule}{EliminateOidGetField}
...
\begin{restatable}[eliminate-$oid$-$value$-$putField$]{crule}{EliminateOidValuePutField}
...
\begin{restatable}[eliminate-$value$-$putStatic$]{crule}{EliminateValuePutStatic}
...
\begin{restatable}[$getClassIDOf$-method-parameter-introduction]{crule}{GetClassIDOfMethodParameterIntroductionRule}
...
\begin{restatable}[$getClassIDOf$-multi-method-parameter-introduction]{crule}{GetClassIDOfMultiMethodParameterIntroductionRule}
  ...
  \begin{circus}
    \begin{array}{l}
      ...
      \t1 (\circvar var1, \ldots, var{<}\ell_1{>} : Word \circspot \\
      \t1 \circvar stack1, \ldots, stack{<}s_1{>} : Word \circspot \\
      \t1 var1 := poppedArgs~1 \circseq \\
      \t2 \vdots \\
      \t1 var{<}n{>} := poppedArgs~1 \circseq \\
      \t2 {} \cdots {}))
      % Remember: Poll starts the \cdots
      \t1 {} \vdots {} \\
      {} \circelse cid = c_m \circthen {} \\
      \t1 (\circvar var1, \ldots, var{<}\ell_m{>} : Word \circspot \\
...
\begin{restatable}[toplevel-method-parameter-introduction]{crule}{ToplevelMethodParameterIntroductionRule}
