...
\begin{crproof}[\nameref{sequence-introduction-rule}]
  ...
  \begin{argue}
    \begin{array}{l}
      ...
      \circfi
    \end{array}\\
    \circrefines_A & Lemma~[\nameref{Running-loop-unroll-lemma}] \\
    \begin{array}{l}
      \circif frameStack = \emptyset \circthen \Skip \\
      {} \circelse frameStack \neq \emptyset \circthen {} \\
      \t1 \circif {} \cdots \\
...
\begin{crproof}[\nameref{if-introduction-rule}]
  ...
  \begin{argue}
    ...
    \begin{array}{l}
      ...
      \circfi
    \end{array}\\
    \circrefines_A & Law~[\nameref{assump-assign-cond-collapse-true-law}] and Law~[\nameref{assump-assign-cond-collapse-false-law}] \\
    \begin{array}{l}
      \circif frameStack = \emptyset \circthen \Skip \\
      {} \circelse frameStack \neq \emptyset \circthen {} \\
      \t1 \circif \cdots \\
    ...
    \begin{array}{l}
      ...
      \circfi
    \end{array}\\
    \circrefines_A & Law~[\nameref{assump-assign-dist-law}] and Lemma~\ref{Poll-assumption-distribution-lemma} \\
    \begin{array}{l}
      \circif frameStack = \emptyset \circthen \Skip \\
      {} \circelse frameStack \neq \emptyset \circthen {} \\
      \t1 \circif \cdots \\
    ...
    \begin{array}{l}
      ...
      \circfi
    \end{array}\\
    \circrefines_A & Law~[\nameref{assign-assump-intro-law}] and Lemma~\ref{Poll-assumption-distribution-lemma} \\
    \begin{array}{l}
      \circif frameStack = \emptyset \circthen \Skip \\
      {} \circelse frameStack \neq \emptyset \circthen {} \\
      \t1 \circif \cdots \\
