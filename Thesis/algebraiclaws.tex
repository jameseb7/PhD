...
% 40 - Law C.71 in Marcel's thesis (oliveira2006: 16)
...
% 41 - Law C.75 in Marcel's thesis (oliveira2006: 17)
...
% 42 - From Law C.101 in Marcel's thesis (oliveira2006: 18)
...
% 44 - Law C.110 in Marcel's thesis (oliveira2006: 20)
...
% 45 - From Law C.112 in Marcel's thesis (oliveira2006: 21)
...
% 46 - Law C.114 in Marcel's thesis (oliveira2006: 22)
...
% 47 - Law C.128 in Marcel's thesis (oliveira2006: 23)
...
% 48 - Law C.129 in Marcel's thesis (oliveira2006: 24)
...
% 49 - Law C.132A in Marcel's thesis (oliveira2006: 25)
\SeqUnitlLaw*

% 50 - Law C.132B in Marcel's thesis (oliveira2006: 26)
\begin{law}[seq-unitr]
  \label{seq-unitr-law}
  \begin{circus}
     A \circseq \Skip = A
...
% 51 - Law C.134 in Marcel's thesis (oliveira2006: 27)
\begin{law}[seq-zerol]
  \label{seq-zerol-law}
  \begin{circus}
...
% 52 - From Law C.139 in Marcel's thesis (oliveira2006: 28)
\begin{law}[var-subst]
...
% 53 - From Corollary 3.1 in Marcel's thesis and the definition of hiding (oliveira2006: 29)
...
% 66 - From the definition of process refinement (Definition 3.2 in Marcel's thesis) (oliveira2006: 30)
\ActionIntroLaw*

% 67 - from application of Law [copy-rule] and Law [action-intro] (derived: 4)
\ActionRenameLaw*

% 68 - From definition B.40 in Marcel's thesis (oliveira2006: 31)
...
% 78 - From Definition 4.3 and Theorem 4.1 in Marcel's thesis (oliveira2006: 32)
\ForwardsDataRefinementLaw*

% 79 - Lemma F.76 in Marcel's extended thesis (oliveira2006: 33)
...
% 80 - From Definition B.51 in Marcel's Thesis (oliveira2006: 34)
\ProcessParamElimLaw*