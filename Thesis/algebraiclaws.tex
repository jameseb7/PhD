...
% Definition B.38 in Marcel's thesis
\begin{law}[res-def]
  \label{res-def-law}
  \begin{circus}
...
% From Law C.139 in Marcel's thesis
\begin{law}[var-subst]
...
% From Corollary 3.1 in Marcel's thesis and the definition of hiding
...
% Law[alt-var-dist-both] in Alvaro's thesis
\begin{law}[var-alt-dist]
  \label{var-alt-dist-law}
  Provided $x$ is not free in $b_1$ or $b_2$, and $b_1 \lor b_2$ and
  $b_1 \implies \lnot b_2$ hold,
  \begin{circus}
    \begin{array}{l}
      \circvar x : T \circspot \\
      \circif b_1 \circthen A \\
      {} \circelse b_2 \circthen B \\
      \circfi
    \end{array}
    =
    \begin{array}{l}
      \circif b_1 \circthen \circvar x : T \circspot A \\
      {} \circelse b_2 \circthen \circvar x : T \circspot B \\
      \circfi
    \end{array}
  \end{circus}
\end{law}
...
% Law[assign-seq-col] in Alvaro's thesis
...
% From definition B.40 in Marcel's thesis and law abA in Ana's thesis
...
% trivial consequence of definition of sequential composition
...
% Lemma F.76 in Marcel's extended thesis
