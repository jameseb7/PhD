...
% 1 - proved in Isabelle (isabelle-proved: 1)
...
% 2 - proved in Isabelle (isabelle-proved: 2)
...
% 3 - proved in Isabelle (isabelle-proved: 3)
...
% 4 - proved in Isabelle (isabelle-proved: 4)
...
% 5 - proved in Isabelle (isabelle-proved: 5)
...
% 6 - proved in Isabelle (isabelle-proved: 6)
...
% 7 - proved in Isabelle (isabelle-proved: 7)
...
% 8 - Proved in Isabelle (similar to Law[assign-seq-dist] in Alvaro's thesis) (isabelle-proved: 8)
...
% 9 - Proved in Isabelle (isabelle-proved: 9)
...
% 10 - Proved in Isabelle (similar to Law[assump-alt-dist] in Alvaro's thesis) (isabelle-proved: 10)
...
% 11 - Needs Proving in Isabelle (follows from Law [assump-alt-dist], Law [assump-elim] and Law [seq-unitl]) (derived: 1)
...
% 12 - Proved in Isabelle (isabelle-proved: 11)
...
% 13 - Proved in Isabelle (isabelle-proved: 12)
...
% 14 - Proved in Isabelle (isabelle-proved: 13)
...
% 15 - Proved in Isabelle (isabelle-proved: 14)
...
% 16 - Proved in Isabelle (isabelle-proved: 15)
...
% 17 - Proved in Isabelle (isabelle-proved: 16)
...
% 18 - Proved in Isabelle (isabelle-proved: 17)
...
% 19 - Proved in Isabelle (isabelle-proved: 18)
...
% 20 - Proved in Isabelle (similar to Law C.53 in Marcel's thesis)  (isabelle-proved: 19)
...
% 21 - Proved in Isabelle  (isabelle-proved: 20)
...
% 22 - TODO: Needs Isabelle proof (similar to Law 18.4 in Programming from Specifications)
...
% 23 - Definition B.28 in Marcel's thesis (oliveira2006: 1)
\CopyRuleLaw*

% 24 - Definition B.37 in Marcel's thesis (oliveira2006: 2)
\begin{law}[val-def]
  \label{val-def-law}
  If $x$ is free in $e$ then,
  \begin{circus}
...
% 25 - Definition B.38 in Marcel's thesis (oliveira2006: 3)
\begin{law}[res-def]
  \label{res-def-law}
  \begin{circus}
...
% 26 - Law C.26 in Marcel's thesis (oliveira2006: 4)
...
% 27 - Law C.27 in Marcel's thesis (oliveira2006: 5)
...
% 28 - Law C.28 in Marcel's thesis (oliveira2006: 6)
...
% 29 - Law C.32 in Marcel's thesis (oliveira2006: 7)
...
% 30 - Law C.33 in Marcel's thesis (oliveira2006: 8)
...
% 31 - Law C.35 in Marcel's thesis (oliveira2006: 9)
\AssumpElimLaw*

% 32 - Law C.36 in Marcel's thesis (oliveira2006: 10)
...
% 33 - Law C.37 in Marcel's thesis (oliveira2006: 11)
...
% 34 - Law C.46 in Marcel's thesis (oliveira2006: 12)
...
% 35 - From Law [assump-output-prefix-dist], Law [assump-elim] and Law [seq-unitl]  (derived: 2)
...
% 36 - Law C.48 in Marcel's thesis (oliveira2006: 13)
...
% 37 - From Law [assump-input-prefix-dist], Law [alt-elim] and Law [seq-unitl] (derived: 3)
...
% 38 - Law C.67 in Marcel's thesis (oliveira2006: 14)
...
% 39 - Law C.68 in Marcel's thesis (oliveira2006: 15)
...
% 40 - Law C.70 in Marcel's thesis (oliveira2006: 16)
\begin{law}[schema-disj-elim]
...
% 41 - Law C.71 in Marcel's thesis (oliveira2006: 17)
...
% 42 - Law C.75 in Marcel's thesis (oliveira2006: 18)
...
% 43 - From Law C.101 in Marcel's thesis (oliveira2006: 19)
...
% 44 - From Law C.101 in Marcel's thesis (oliveira2006: 20)
...
% 45 - Law C.110 in Marcel's thesis (oliveira2006: 21)
...
% 46 - From Law C.112 in Marcel's thesis (oliveira2006: 22)
...
% 47 - Law C.114 in Marcel's thesis (oliveira2006: 23)
...
% 48 - Law C.128 in Marcel's thesis (oliveira2006: 24)
...
% 49 - Law C.129 in Marcel's thesis (oliveira2006: 25)
...
% 50 - Law C.132A in Marcel's thesis (oliveira2006: 26)
\SeqUnitlLaw*

% 51 - Law C.132B in Marcel's thesis (oliveira2006: 27)
\begin{law}[seq-unitr]
  \label{seq-unitr-law}
  \begin{circus}
     A \circseq \Skip = A
...
% 52 - Law C.134 in Marcel's thesis (oliveira2006: 28)
\begin{law}[seq-zerol]
  \label{seq-zerol-law}
  \begin{circus}
...
% 53 - From Law C.139 in Marcel's thesis (oliveira2006: 29)
\begin{law}[var-subst]
  If $y$ is not free in $A$
  \label{var-subst-law}
  \begin{circus}
    A(x) = \circvar y : T \circspot y := x \circseq A(y)
  \end{circus}
\end{law}

% 54 - From Corollary 3.1 in Marcel's thesis and the definition of hiding (oliveira2006: 30)
...
% 55 - Law[var-seq-ext-left] in Alvaro's thesis (from C.137 in Marcel's thesis) (miyazawa2012: 1)
...
% 56 - Law[var-seq-ext-right] in Alvaro's thesis (from C.137 in Marcel's thesis) (miyazawa2012: 2)
...
% 57 - Law[var-assign-intro] in Alvaro's thesis (miyazawa2012: 3)
...
% 58 - Law[var-prefix-ext] in Alvaro's thesis (miyazawa2012: 4)
...
% 59 - Law[assign-seq-col] in Alvaro's thesis (miyazawa2012: 5)
\begin{law}[assign-seq-col]
...
% 60 - Law[assign-schema-conv] in Alvaro's thesis (miyazawa2012: 6)
...
% 61 - Law[assign-seq-com] in Alvaro's thesis (miyazawa2012: 7)
...
% 62 - Law[var-rename] in Alvaro's thesis (miyazawa2012: 8)
...
% 63 - Law scompC in ZRC paper (zrc: 1)
...
% 64 - From Definition B.40 in Marcel's thesis and Law vrbI in ZRC paper (zrc: 2)
...
% 65 - From definition B.40 in Marcel's thesis and law abA in Ana's thesis (zrc: 3)
\begin{law}[assump-schema-absorb]
  \label{assump-schema-absorb-law}
  \begin{circus}
    \{ g \} \circseq \lschexpract [decls | pred] \rschexpract
    =
    \lschexpract [decls | g \land pred] \rschexpract
  \end{circus}
\end{law}

% 66 - From the definition of process refinement (Definition 3.2 in Marcel's thesis) (oliveira2006: 31)
\ActionIntroLaw*

% 67 - from application of Law [copy-rule] and Law [action-intro] (derived: 4)
\ActionRenameLaw*

% 68 - From definition B.40 in Marcel's thesis (oliveira2006: 32)
...
% 69 - From Exercise 2.6.4(2) in the UTP book with (utp-book: 1)
% F(X) = \{g\} \circseq f(X)
% G(X) = X \circseq \{g\}
% H(X) = f(X)
...
% 70 - From the dual of Exercise 2.6.4 in the UTP book and Theorem 7.15 (utp-book: 2)
...
% 72 - From Definition B.36 in Marcel's thesis and Laws 2.9L1 and 2.9L2 in the UTP book (utp-book: 4)
...
% 73 - From Exercise 2.6.4(2) in the UTP book with (utp-book: 5)
% F(X) = A \circseq X
% G(X) = X \circseq B
% H(X) = A \circseq X
\RecActionIntroLaw*

% 74 - Exercise 2.6.4(1) in the UTP book (utp-book: 6)
\RecRollingRuleLaw*

% 75 - TODO: needs proof (should follow from Definition B.40 in Marcel's  (derived: 5)
...
% 76 - TODO: needs proof (similar to Law[alt-var-dist-both] in Alvaro's
% thesis)
...
% 77 - trivial consequence of definition of sequential composition (derived: 6)
\begin{law}[assign-elim]
...
% 78 - From Definition 4.3 and Theorem 4.1 in Marcel's thesis (oliveira2006: 33)
\ForwardsDataRefinementLaw*

% 79 - Lemma F.76 in Marcel's extended thesis (oliveira2006: 34)
\begin{law}[simulation-decomposition]
  ...
  then
  \begin{circus}
    \mathbf{R}(P_C \vdash Q_C) \land CI \implies \exists v'_A \circspot \mathbf{R}(P_A \vdash Q_A) \land CI
   \end{circus}
\end{law}

% 80 - From Definition B.51 in Marcel's Thesis (oliveira2006: 35)
\ProcessParamElimLaw*