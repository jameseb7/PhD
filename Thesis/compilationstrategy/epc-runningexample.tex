...
\begin{figure}[p!]
  ...
  \addchange{Expanded Figure~\ref{bytecode-expansion-example-figure}
...
\begin{figure}[tp!]
  ...
  \small
  \addchange{Changed
    Figure~\ref{forward-sequence-introduction-example-figure} to
...
\begin{figure}[tp!]
  ...
  \setlength{\belowdisplayskip}{0cm}
  \addchange{Changed
    Figure~\ref{loop-and-conditional-introduction-example-figure} to
...
\begin{figure}[tp!]
  ...
  \setlength{\abovedisplayskip}{0cm}
  \setlength{\belowdisplayskip}{0cm}
  \addchange{Moved $TPK\_f$ action to its own figure}
  \moved{
  \begin{circus}
...
\begin{figure}[tp!]
  ...
  \setlength{\belowdisplayskip}{0cm}
  \addchange{Changed
    Figure~\ref{method-call-resolution-example-figure} to
...
\begin{figure}[tp!]
  ...
  \setlength{\abovedisplayskip}{0cm}
  \setlength{\belowdisplayskip}{0cm}
  \addchange{Inserted full definition of $TPK\_handleAsyncEvent$ and
...
\added{
At the end of the loop in Algorithm~\ref{epc-algorithm}, when all
loops and conditionals have been introduced, all the methods have been
separated out, and all method calls have been resolved, the actions at
$pc = 0$ are separated into a $TPK\_APEHinit$ action, and the actions
at $pc = 7$ are separated into a $TPK\_handleAsyncEvent$ action.
These actions are shown in
Figure~\ref{method-separation-handleAsyncEvent-example-figure}.
The $Running$ action at this point in the strategy is then as shown in
...
\begin{figure}
  ...
  \addchange{Inserted full defintion of $TPK\_handleAsyncEvent$ in
