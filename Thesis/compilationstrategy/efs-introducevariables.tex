  ...
  \begin{algorithmic}[1]
   ...
   {Law~[\nameref{forwards-data-refinement-law}]}
    ...
    \MatchIn{
     ...
     \label{algorithm-introduce-variables-method-elim}
     % rename new method action
     \State \ApplyFor{Law~[\nameref{action-rename-law}]}{$methodName'$, $methodName$}
     \label{algorithm-introduce-variables-rename-method}
...
However, \Call{IntroduceFrameClassAssumptions}{} acts on over the body
...
Rule~[\nameref{var-parameter-conversion-rule}], via an application of
