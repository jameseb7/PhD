...
\begin{algorithm}[ht]
  \begin{algorithmic}[1]
    ...
    \State \Call{RedefineMethodActionExcludingReturnAction}{$methodName$,$returnAction$}
...
Having determined the return action for a method, we convert it to a
...
separate procedure
\Call{RedefineMethodActionExcludingReturnAction}{$methodName$,$returnAction$},
called on
