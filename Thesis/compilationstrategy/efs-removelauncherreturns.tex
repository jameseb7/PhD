...
which shows the form of $TPK\_handleAsyncEvent$\addchange{Removed highlighting in Figures~\ref{efs-eliminate-returns-MainThread-Started-figure} and~\ref{}}\deleted{, with those data
