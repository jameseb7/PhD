...
The effect of this data refinement is that the operations to set the
$frameStackID$ are reduced to $\Skip$ and, as mentioned above,
$(last~frameStack).frameClass$ is inserted wherever $currentClass$
occurs in the old actions.
