...
\begin{algorithm}
  \begin{algorithmic}[1]
    ...
    \State \Call{RedefineMethodActionToIncludeParameters}{$methodName$}
...
\Call{RedefineMethodActionToIncludeParameters}{}, which is similar to
the \Call{RedefineMethodActionExcludingReturnAction}{} procedure used
