...
% We then remove $currentClass$ and $frameStackID$ from the state, so
% that the remainder of the stage can operate solely on $frameStack$, on
% line~\ref{algorithm-remove-currentClass}.
