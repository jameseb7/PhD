...
The boolean value indicating whether the method is static is required
to be $\true$, since all the special methods we define are static.
...
\begin{restatable}[resolve-special-method]{crule}{ResolveSpecialMethodRule}
  ...
  Table~\ref{special-method-action-table} and $s = \true$, then
