...
\begin{crule}[Bytecode Expansion]
...
\begin{crule}[Sequence introduction]
...
\begin{algorithm}
  \begin{algorithmic}[1]
    ...
    \State \Call{ApplyLemma\Autoref{if-introduction-rule}}{$node$}
    \label{algorithm-introduce-if}
    \State \Call{ApplyLemma\Autoref{if-else-introduction-rule}}{$node$}
...
conditionals.
\begin{crule}[\texttt{if} conditional introduction]
...
\begin{crule}[\texttt{if}-\texttt{else} conditional introduction]
...
\begin{crule}[Conditional introduction]
...
\begin{crule}[\texttt{while} loop introduction 1]
...
%
\begin{crule}[Method call resolution]
...
this choice.
%
\begin{crule}[Dynamic method call resolution]
...
\begin{crule}[Main Action Refinement]
