...
\begin{algorithm}
  \begin{algorithmic}[1]
    ...
    \label{algorithm-collapse-handle-instruction}
    \EndFor
  \end{algorithmic}
...
occurrence of $HandleInstruction$ at each $pc$ value, applying Rule
[\nameref{HandleInstruction-refinement-rule}], shown below, to refine
