...
Then, in Section~\ref{compilation-preconditions-sections} we describe
...
Due to the considerations discussed above, we require the control flow
...
For precision and since it is used in the proof of the theorem for the
...
\begin{figure}
  \begin{subfigure}{0.24\textwidth}
    \begin{center}
      \begin{tikzpicture}
        \useasboundingbox (-2,-2.5) rectangle (2,2);
        \node at (0,2) (start) {};
        \node at ( 0, 1)  (A) {$a$};
        \node at (-1, 0)  (B) {$b$};
        \node at ( 0,0)   (D) {$c$};
