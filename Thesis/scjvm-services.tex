...
So memory area entering operations are implemented in the CEE.
...
\added{
Our formal model of the SCJVM services provides a specification that
supports our specification of the core execution environment described
in the next chapter, which forms the basis for our compilation
strategy, descibed in Chapter~\ref{strategy-chapter}.
The model of the SCJVM services can thus be used to create an SCJVM
services implementation by refinement from the model, which can be
translated to executable code.
This implementation can thus support the output of the compilation
strategy.
