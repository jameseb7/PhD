...
% definitions for compatibility with the change tracking mechanism
\newcommand{\added}[1]{#1}
...
\title{\protect\addchange{Changed title to not refer to
    ...
    Compilation for\\Safety-Critical Java}}
\author{James Baxter}
\date{}
...
%TC:macro \IfExtended [text]
%TC:macro \IfNotExtended [ignore]
\Extendedtrue
...
\begin{titlepage}
  ...
  \vfill
  \vfill
  {\Huge\bf \thetitle\\(Extended Version)}
  \vfill
  \vfill
  {\huge \theauthor}
  \vfill
