...
in Table~\ref{tbl:zdecl:global}, which was generated using the
declaration counting facilities of CZT's \LaTeX style.
...
environments and \Circus{} action environments are not counted, although
plain \Circus{} environments are.
