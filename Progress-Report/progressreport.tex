...
There is also a related approach of deriving a compiler from an
operational semantics of the source language that has recently been
developed~\cite{bahr2015}.
In this approach, the operational semantics of the source
language and a way of relating the source and target semantics are
used to derive a diiferent operational semantics of the source
language acting on the state of the target machine.
...
Finally, we have left six months at the end of the project for final
