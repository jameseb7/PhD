...
%TODO: Do we need to discuss SCJVM Services?
...
\begin{frame}
  ...
  \item The C code is represented by processes representing C threads.
    \begin{itemize}
    \item Same structure as for Interpreter threads
    \end{itemize}
  ...
  \item Objects are structs represented by Z schema bindings.
    \begin{itemize}
    \item Managed by a Struct Manager, which replaces the Object Manager
    \end{itemize}
  \end{itemize}
\end{frame}
